...
try:
    ...
    logger.info(
        f"Developer portal loaded successfully: {HTML_FILE}"
    )

except Exception as e:
    logger.error(
        f"Failed to load developer portal HTML: {e}"
    )
    ...
    <body>
        <div class="box">
            <h1>Magma API</h1>
            <p>Developer portal failed to load.</p>
            <pre>
    """ + str(e) + """
            </pre>
        </div>
    ...
    while True:
        ...
        try:
            ...
            if (
                ...
                logger.info(
                    f"Cleanup complete: "
                    f"Deleted {deleted_files} old files, "
